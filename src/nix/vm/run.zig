...
const handlers: [opcode.count]HandlerFn = blk: {
    ...
    table[@intFromEnum(OpCode.clos)] = opClosure;
    table[@intFromEnum(OpCode.clos_w)] = opClosureLong;
    table[@intFromEnum(OpCode.clos_cap)] = opClosureCaptures;
    table[@intFromEnum(OpCode.clos_cap_w)] = opClosureCapturesLong;
    table[@intFromEnum(OpCode.thk_arg)] = opApplyArg;
    table[@intFromEnum(OpCode.thk)] = opThunkCaptures;
    table[@intFromEnum(OpCode.thk_w)] = opThunkCapturesLong;
    table[@intFromEnum(OpCode.thk_eag)] = opThunkCapturesEager;
    table[@intFromEnum(OpCode.thk_eag_w)] = opThunkCapturesEagerLong;
    table[@intFromEnum(OpCode.thk_st_cell)] = opThunkCapturesStoreCellLocal;
    table[@intFromEnum(OpCode.thk_st)] = opThunkCapturesStoreLocal;
    table[@intFromEnum(OpCode.thk_eag_st_cell)] = opThunkCapturesEagerStoreCellLocal;
    table[@intFromEnum(OpCode.thk_eag_st)] = opThunkCapturesEagerStoreLocal;
    ...
    table[@intFromEnum(OpCode.thk_shell)] = opMakeLazyShell;
    ...
    table[@intFromEnum(OpCode.thk_defer)] = opDeferAttrValue;
