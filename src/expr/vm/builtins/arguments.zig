...
pub fn dupPathAttr(self: *VM, attrs_id: ObjectId, name: []const u8) ![]u8 {
    ...
    return switch (value.kind()) {
        .path, .string, .string_context, .heap_string => self.allocator.dupe(u8, try vm_strings.stringBytes(self, value)),
...
pub fn optionalStringAttr(self: *VM, attrs_id: ObjectId, name: []const u8) !?[]u8 {
    ...
    return try self.allocator.dupe(u8, try vm_strings.stringBytes(self, forced));
}
