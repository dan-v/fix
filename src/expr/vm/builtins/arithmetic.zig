...
pub fn builtinCeil(self: *VM, arg: Value) !Value {
    const v = try vm_force.forceValue(self, arg);
...
fn floorCeilResult(self: *VM, err: anyerror, v: Value, name: []const u8) anyerror!Value {
...
/// through untouched.
fn floorCeilError(self: *VM, err: anyerror, v: Value, name: []const u8) anyerror {
