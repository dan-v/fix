...
pub fn apply(
    ...
    switch (id) {
        ...
        .check_cache_status => options.check_cache_status = true,
        .max_depth => options.max_depth = std.fmt.parseInt(usize, v0.?, 10) catch return error.InvalidMaxDepth,
        .gc_roots_dir => options.gc_roots_dir = v0.?,
        .max_memory_size => options.max_memory_size = std.fmt.parseInt(usize, v0.?, 10) catch return error.InvalidMaxMemorySize,
        .force_recurse => options.force_recurse = true,
        .meta => options.meta = true,
        .no_instantiate => options.no_instantiate = true,
        .apply_expr => options.apply_expr = v0.?,
        .select_expr => options.select_expr = v0.?,
        .show_input_drvs => options.show_input_drvs = true,
        .constituents => options.constituents = true,
